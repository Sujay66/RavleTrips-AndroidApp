...
public class RavelFirebaseMessagingService extends FirebaseMessagingService {

    private static final String TAG = "RavelFbMsgService";
    ...
    private void handleNow(Map<String,String> data) {
        Log.d(TAG, "Handling topic message:"+data);
